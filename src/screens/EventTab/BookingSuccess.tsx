...
const BookingSuccess = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.page} ref={ref} collapsable={false}>
      ...
      <LinearGradient ref={cardRef} style={styles.card} colors={['#E2E689', '#FFFFFF']} start={{x: 0, y: 0}} end={{x: 1, y: 0}}>
      ...
      <TouchableOpacity style={styles.downloadBtn} onPress={onDownload} disabled={processing}>
        {processing ? <ActivityIndicator color="#222" /> : <Text style={styles.downloadText}>Download E-Workshop</Text>}
      </TouchableOpacity>
